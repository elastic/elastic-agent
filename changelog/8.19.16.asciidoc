...
* Update go to v1.26.2. https://github.com/elastic/elastic-agent/pull/13683[#13683] 
...
* Update OTel components to v0.150.0. https://github.com/elastic/elastic-agent/pull/14077[#14077] 
...
* Stop Windows service promptly while the agent is retrying enrollment. https://github.com/elastic/elastic-agent/pull/13878[#13878] 
* Fix profiling agent daemonset for K8s versions v1.33&#43;. https://github.com/elastic/elastic-agent/pull/13894[#13894] 
* Clamp non-positive agent.download.retry_sleep_init_duration to default 30s. https://github.com/elastic/elastic-agent/pull/13974[#13974] 
