...
func reconcileServiceAccount(ctx context.Context,
	log *logger.Logger,
	...
	return false, reconcileResource(ctx, log, compStart, client, expected, &reconciled, expected.Name, namespace, kind, false)
}

func ServiceAccountName(base string) string {
	return escapeK8sName(base + "ServiceAccount")
}
