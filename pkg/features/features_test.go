...
func TestOtelRuntimeSubprocessExecution(t *testing.T) {
	tcs := []struct {
		name string
		yaml string
		want bool
		...
		{
			name: "OtelRuntimeSubprocessExecution enabled",
			yaml: `
agent:
  features:
    otel:
      subprocess_execution: true`,
		...
		{
			name: "OtelRuntimeSubprocessExecution disabled",
			yaml: `
agent:
  features:
    otel:
      subprocess_execution: false`,
		...
		{
			name: "OtelRuntimeSubprocessExecution only {}",
			yaml: `
agent:
  features:
    subprocess_execution: {}`,
		...
		{
			name: "OtelRuntimeSubprocessExecution empty",
			yaml: `
agent:
  features:
    fqdn:`,
		...
		{
			name: "OtelRuntimeSubprocessExecution absent",
			yaml: `
agent:
  features:`,
			want: false,
