...
func GetAgentByHostnameFromList(client *kibana.Client, hostname string) (*kibana.AgentExisting, error) {
	listAgentsResp, err := client.ListAgents(context.TODO(), kibana.ListAgentsRequest{})
	if err != nil {
		return nil, err
	}
...
func UnEnrollAgent(client *kibana.Client) error {
	...
	_, err = client.UnEnrollAgent(context.TODO(), unEnrollAgentReq)
	if err != nil {
...
func UpgradeAgent(client *kibana.Client, version string) error {
	...
	_, err = client.UpgradeAgent(context.TODO(), upgradeAgentReq)
	if err != nil {
...
func GetDefaultFleetServerURL(client *kibana.Client) (string, error) {
	...
	resp, err := client.ListFleetServerHosts(context.TODO(), req)
	if err != nil {
