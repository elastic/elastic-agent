...
func TestLess(t *testing.T) {
	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			...
			assert.Equal(t, left.LessWithGreaterPrerelease(*right), tc.lessGreaterPrerelease)
		})
	}
}
