...
type ElasticAgentControlClient interface {
	...
	// Fetches the current states of the Elastic Agent.
	...
	// of the Elastic Agent has changed. Pass StateWatchRequest with
	// latest_only=true to receive only the most recent state on each read,
	// skipping intermediate transitions.
	StateWatch(ctx context.Context, in *StateWatchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StateResponse], error)
	...
	// AvailableRollbacks returns any existing agent installs that can be used as a target for a manual rollback operation
...
func (c *elasticAgentControlClient) StateWatch(ctx context.Context, in *StateWatchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StateResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[StateWatchRequest, StateResponse]{ClientStream: stream}
...
type ElasticAgentControlServer interface {
	...
	// latest_only=true to receive only the most recent state on each read,
	// skipping intermediate transitions.
	StateWatch(*StateWatchRequest, grpc.ServerStreamingServer[StateResponse]) error
	// Restart restarts the current running Elastic Agent.
...
func (UnimplementedElasticAgentControlServer) StateWatch(*StateWatchRequest, grpc.ServerStreamingServer[StateResponse]) error {
	return status.Error(codes.Unimplemented, "method StateWatch not implemented")
}
...
func (UnimplementedElasticAgentControlServer) DiagnosticAgent(context.Context, *DiagnosticAgentRequest) (*DiagnosticAgentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DiagnosticAgent not implemented")
}
func (UnimplementedElasticAgentControlServer) DiagnosticUnits(*DiagnosticUnitsRequest, grpc.ServerStreamingServer[DiagnosticUnitResponse]) error {
	return status.Error(codes.Unimplemented, "method DiagnosticUnits not implemented")
}
func (UnimplementedElasticAgentControlServer) DiagnosticComponents(*DiagnosticComponentsRequest, grpc.ServerStreamingServer[DiagnosticComponentResponse]) error {
	return status.Error(codes.Unimplemented, "method DiagnosticComponents not implemented")
}
...
func (UnimplementedElasticAgentControlServer) AvailableRollbacks(context.Context, *Empty) (*AvailableRollbacksResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AvailableRollbacks not implemented")
}
...
func RegisterElasticAgentControlServer(s grpc.ServiceRegistrar, srv ElasticAgentControlServer) {
	// If the following call panics, it indicates UnimplementedElasticAgentControlServer was
...
func _ElasticAgentControl_StateWatch_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StateWatchRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ElasticAgentControlServer).StateWatch(m, &grpc.GenericServerStream[StateWatchRequest, StateResponse]{ServerStream: stream})
}
