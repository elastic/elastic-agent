...
//   - ctx context.Context
func (_e *MockClient_Expecter) StateWatch(ctx any) *MockClient_StateWatch_Call {
...
func (_mock *MockClient) Upgrade(ctx context.Context, version string, sourceURI string, skipVerify bool, skipDefaultPgp bool, pgpBytes ...string) (string, error) {
	...
	var r0 string
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, bool, bool, ...string) (string, error)); ok {
		return returnFunc(ctx, version, sourceURI, skipVerify, skipDefaultPgp, pgpBytes...)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, bool, bool, ...string) string); ok {
		r0 = returnFunc(ctx, version, sourceURI, skipVerify, skipDefaultPgp, pgpBytes...)
	} else {
		r0 = ret.Get(0).(string)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string, bool, bool, ...string) error); ok {
		r1 = returnFunc(ctx, version, sourceURI, skipVerify, skipDefaultPgp, pgpBytes...)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
//   - skipDefaultPgp bool
//   - pgpBytes ...string
func (_e *MockClient_Expecter) Upgrade(ctx any, version any, sourceURI any, skipVerify any, skipDefaultPgp any, pgpBytes ...any) *MockClient_Upgrade_Call {
	return &MockClient_Upgrade_Call{Call: _e.mock.On("Upgrade",
		append([]any{ctx, version, sourceURI, skipVerify, skipDefaultPgp}, pgpBytes...)...)}
}
...
func (_c *MockClient_Upgrade_Call) RunAndReturn(run func(ctx context.Context, version string, sourceURI string, skipVerify bool, skipDefaultPgp bool, pgpBytes ...string) (string, error)) *MockClient_Upgrade_Call {
	_c.Call.Return(run)
	return _c
}
