...
const (
	ElasticAgentControl_Version_FullMethodName = "/proto.ElasticAgentControl/Version"
	ElasticAgentControl_Status_FullMethodName  = "/proto.ElasticAgentControl/Status"
	ElasticAgentControl_Restart_FullMethodName = "/proto.ElasticAgentControl/Restart"
	ElasticAgentControl_Upgrade_FullMethodName = "/proto.ElasticAgentControl/Upgrade"
)
...
func (c *elasticAgentControlClient) Status(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*StatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, ElasticAgentControl_Status_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ElasticAgentControl_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ElasticAgentControl_Status_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
