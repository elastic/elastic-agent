...
// elastic-agent-client namespace is likely to change after 8.6
...
type ElasticAgentControlClient interface {
	...
	// Fetches the current status of the Elastic Agent.
...
func (c *elasticAgentControlClient) Status(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*StatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, ElasticAgentControl_Status_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
