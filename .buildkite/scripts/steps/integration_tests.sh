...
set +e
AGENT_VERSION="${OVERRIDE_TEST_AGENT_VERSION}"  TEST_INTEG_AUTH_ESS_REGION=azure-eastus2 TEST_INTEG_CLEAN_ON_EXIT=true STACK_PROVISIONER="$STACK_PROVISIONER" TEST_INTEG_CLEAN_ON_EXIT=true SNAPSHOT=true mage $MAGE_TARGET $MAGE_SUBTARGET
TESTS_EXIT_STATUS=$?
set -e
