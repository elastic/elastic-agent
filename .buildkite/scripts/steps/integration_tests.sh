...
TESTS_EXIT_STATUS=$?
AGENT_VERSION="${OVERRIDE_TEST_AGENT_VERSION}" STACK_PROVISIONER="ess" TEST_INTEG_CLEAN_ON_EXIT=true SNAPSHOT=true mage integration:single TestMonitoringLogsShipped
TESTS_EXIT_STATUS+=$?
set -e
