...
![Version: 8.17.7-beta](https://img.shields.io/badge/Version-8.17.7--beta-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 8.17.7](https://img.shields.io/badge/AppVersion-8.17.7-informational?style=flat-square)
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| agent.version | string | `"8.17.7"` | elastic-agent version |
| agent.image | object | `{"pullPolicy":"IfNotPresent","repository":"docker.elastic.co/elastic-agent/elastic-agent","tag":"8.17.7-SNAPSHOT"}` | image configuration |
