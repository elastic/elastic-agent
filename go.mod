...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20241126231543-1bd39c5cf55e
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kubelet v0.114.0 // indirect
