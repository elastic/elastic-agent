...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20250625112624-7bfa78e27177
...
// Local dev replace for dev/testing purposes ONLY!
replace github.com/elastic/elastic-agent-libs => github.com/pchila/elastic-agent-libs v0.0.0-20250625135236-36a5aadd7019
