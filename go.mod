...
require (
	...
	github.com/elastic/prometheus v0.54.1-elastic.1 // indirect
...
replace (
	...
	github.com/elastic/beats/v7 => github.com/tommyers-elastic/beats/v7 v7.0.0-alpha2.0.20250307142910-70dfc1c0b556
