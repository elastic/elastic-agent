...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20251215091333-fa9e782f9a39
...
>>>>>>> 07d5c3a34 (build(deps): bump github.com/elastic/elastic-agent-system-metrics from 0.13.4 to 0.13.5 (#11858))
