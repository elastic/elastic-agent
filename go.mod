...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20260106124222-f0de8ac668ec
...
>>>>>>> 308c9688f (build(deps): bump github.com/elastic/elastic-agent-system-metrics from 0.13.5 to 0.13.6 (#12135))
