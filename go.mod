...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20240926115706-07360ca6f8df // indirect
...
replace (
	...
	github.com/prometheus/prometheus v0.54.1 => github.com/prometheus/prometheus v1.8.2-0.20210701133801-b0944590a1c9
)
