...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/status v0.122.0
...
require (
	...
	go.opentelemetry.io/collector/extension/memorylimiterextension v0.122.0
...
require (
	...
	github.com/v1v/gotestsum v0.0.2 // indirect
