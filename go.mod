...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20260620162656-f4fbbcbb3b04
...
>>>>>>> 8c221f1a6 ([otel]: set profiles feature-gates flag if profiles pipeline is configured (#15012))
