...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20251022162134-9da0f31ee2cc
	...
	github.com/elastic/opentelemetry-collector-components/processor/elasticapmprocessor v0.20.0
