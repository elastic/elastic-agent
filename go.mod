...
require (
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20220124123401-c570227b30f3
...
replace (
	...
	github.com/elastic/e2e-testing => github.com/narph/e2e-testing v1.99.2-0.20220111115708-84b086496094
