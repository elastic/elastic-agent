...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/status v0.120.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/geoipprocessor v0.120.0
