...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20260604200219-978dfb2ff06c
...
>>>>>>> e8ffee8bf (bump x/net to v0.55.0 (#14804))
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/elasticsearchexporter v0.153.0 // indirect
