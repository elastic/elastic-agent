...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20260412180418-1f8837745860
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/elasticsearchexporter v0.149.0 // indirect
