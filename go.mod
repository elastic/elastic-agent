...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20250813092258-777157e2eafb
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/signaltometricsconnector v0.131.0 // indirect
