...
require (
	...
	github.com/elastic/opentelemetry-collector-components/processor/elasticinframetricsprocessor v0.5.0
...
require (
	...
	github.com/elastic/opentelemetry-lib v0.6.0 // indirect
