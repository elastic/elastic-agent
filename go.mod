...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20250708234325-b8fb93227ed5
	...
	github.com/elastic/opentelemetry-collector-components/receiver/elasticapmintakereceiver v0.1.0
