...
* Set OTel as the default runtime for Filebeat inputs. [#13991](https://github.com/elastic/elastic-agent/pull/13991)
* Add support for Auditbeat, Heartbeat, Osquerybeat, and Packetbeat to run in `otel` mode. [#14029](https://github.com/elastic/elastic-agent/pull/14029)
