## 9.3.7 [elastic-agent-release-notes-9.3.7]



### Features and enhancements [elastic-agent-9.3.7-features-enhancements]
...
* Fix an issue where Beat receiver trace logs were missing from the diagnostics bundle. [#15082](https://github.com/elastic/elastic-agent/pull/15082) 
