...
url: https://docs-v3-preview.elastic.dev/reference/edot-collector/config/configure-metrics-collection
products:
  - Elastic Agent
...
For a full list of supported receivers, see the EDOT Collector components [reference](https://docs-v3-preview.elastic.dev/reference/edot-collector/components).