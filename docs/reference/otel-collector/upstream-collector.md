...
Point your contrib Collector OTLP exporter to the EDOT gateway. Refer to [Gateway configuration](/reference/otel-collector/config/default-config-standalone.md#gateway-mode) for more information.
...
- [Build a custom EDOT-like collector](/reference/otel-collector/custom-collector.md) for more control.
- [Configure the EDOT Collector](/reference/otel-collector/config/index.md) for optimal Elastic integration.
- [Learn about EDOT components](/reference/otel-collector/components.md) to understand what's included.
