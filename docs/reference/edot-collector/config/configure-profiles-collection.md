...
The generated metrics power the [Elastic OTel Profiling Metrics integration](https://www.elastic.co/docs/reference/integrations/profilingmetrics_otel) dashboards.
