...
EDOT_COLLECTOR_DIR = '../../../docs/reference/otel-collector'
...
COMPONENT_DOCS_YAML = '../../../docs/reference/otel-collector/component-docs.yml'
DEFAULT_CONFIG_FILE = '../../../docs/reference/otel-collector/config/default-config-standalone.md'
