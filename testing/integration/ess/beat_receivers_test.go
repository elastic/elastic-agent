...
<<<<<<< HEAD:testing/integration/beat_receivers_test.go
=======
...
>>>>>>> 73737c9a3 ([test] split up ess and beats serverless integration tests (#8551)):testing/integration/ess/beat_receivers_test.go
}
