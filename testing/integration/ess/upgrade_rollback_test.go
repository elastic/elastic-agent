...
func TestFleetManagedUpgradeRollback(t *testing.T) {
	...
	// upgrade target to 9.3.0 rather than using PreviousMinor() (which may
	// resolve to 9.2.x when the versions list has no stable 9.3 entry and
	// would cause the Fleet API to reject the rollback with "upgrade
	// rollback not available for agent").
