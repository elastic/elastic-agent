...
<<<<<<< HEAD:testing/integration/endpoint_security_test.go
=======
	"github.com/elastic/elastic-agent/pkg/version"
	"github.com/elastic/elastic-agent/testing/integration"
>>>>>>> 73737c9a3 ([test] split up ess and beats serverless integration tests (#8551)):testing/integration/ess/endpoint_security_test.go
