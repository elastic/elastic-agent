...
func TestSwitchUnprivilegedWithBasePath(t *testing.T) {
	...
	require.NoError(t, installtest.CheckSuccess(ctx, fixture, topPath, &installtest.CheckOpts{Privileged: true, Version: define.Version()}))
	...
	require.NoError(t, installtest.CheckSuccess(ctx, fixture, topPath, &installtest.CheckOpts{Privileged: false, Version: define.Version()}))
}
