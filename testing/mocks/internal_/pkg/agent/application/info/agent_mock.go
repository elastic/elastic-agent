...
// ECSMetadata provides a mock function with given fields: _a0
func (_m *Agent) ECSMetadata(_a0 *logp.Logger) (*info.ECSMeta, error) {
	ret := _m.Called(_a0)
	...
	var r0 *info.ECSMeta
	var r1 error
	if rf, ok := ret.Get(0).(func(*logp.Logger) (*info.ECSMeta, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(*logp.Logger) *info.ECSMeta); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*info.ECSMeta)
		}
	}

	if rf, ok := ret.Get(1).(func(*logp.Logger) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
// Agent_ECSMetadata_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ECSMetadata'
type Agent_ECSMetadata_Call struct {
	*mock.Call
}

// ECSMetadata is a helper method to define mock.On call
//   - _a0 *logp.Logger
func (_e *Agent_Expecter) ECSMetadata(_a0 interface{}) *Agent_ECSMetadata_Call {
	return &Agent_ECSMetadata_Call{Call: _e.mock.On("ECSMetadata", _a0)}
}

func (_c *Agent_ECSMetadata_Call) Run(run func(_a0 *logp.Logger)) *Agent_ECSMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*logp.Logger))
	})
	return _c
}

func (_c *Agent_ECSMetadata_Call) Return(_a0 *info.ECSMeta, _a1 error) *Agent_ECSMetadata_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Agent_ECSMetadata_Call) RunAndReturn(run func(*logp.Logger) (*info.ECSMeta, error)) *Agent_ECSMetadata_Call {
	_c.Call.Return(run)
	return _c
}
