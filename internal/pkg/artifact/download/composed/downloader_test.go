...
func (d *FailingDownloader) Download(ctx context.Context, _ string, _ component.Spec, _ string) (string, error) {
	d.called = true
...
func (d *SuccDownloader) Download(ctx context.Context, _ string, _ component.Spec, _ string) (string, error) {
	d.called = true
	return "succ", nil
}
...
func TestComposed(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		r, _ := d.Download(context.TODO(), "", component.Spec{Name: "a"}, "b")
