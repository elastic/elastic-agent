...
func (d *FailingDownloader) Download(ctx context.Context, _ component.Spec, _ string) (string, error) {
	d.called = true
...
func (d *SuccDownloader) Download(ctx context.Context, _ component.Spec, _ string) (string, error) {
	d.called = true
	return "succ", nil
}
