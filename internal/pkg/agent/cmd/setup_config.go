...
func defaultAccessConfig() (setupConfig, error) {
	...
	cfg := setupConfig{
		...
		FleetServer: fleetServerConfig{
			...
			PassphraseFile: envWithDefault("", "FLEET_SERVER_CERT_KEY_PASSPHRASE_FILE"),
			Elasticsearch: elasticsearchConfig{
				...
				ServiceTokenFile:     envWithDefault("", "FLEET_SERVER_SERVICE_TOKEN_FILE"),
		...
		Kibana: kibanaConfig{
			Fleet: kibanaFleetConfig{
				...
				ServiceTokenFile: envWithDefault("", "KIBANA_FLEET_SERVICE_TOKEN_FILE", "FLEET_SERVER_SERVICE_TOKEN_FILE"),
