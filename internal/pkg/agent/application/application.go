...
func New(
	...
	otelManager, err := otelmanager.NewOTelManager(log.Named("otel_manager"), logLevel, baseLogger, otelmanager.SubprocessExecutionMode, agentInfo, monitor.ComponentMonitoringConfig)
	if err != nil {
