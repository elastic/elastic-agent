...
func (_m *mockInstallDescriptorSource) RemoveAgentInstallDesc(versionedHome ...string) (*v1.InstallDescriptor, error) {
	_va := make([]interface{}, len(versionedHome))
	for _i := range versionedHome {
		_va[_i] = versionedHome[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
...
func (_e *mockInstallDescriptorSource_Expecter) RemoveAgentInstallDesc(versionedHome ...interface{}) *mockInstallDescriptorSource_RemoveAgentInstallDesc_Call {
	return &mockInstallDescriptorSource_RemoveAgentInstallDesc_Call{Call: _e.mock.On("RemoveAgentInstallDesc",
		append([]interface{}{}, versionedHome...)...)}
}
