...
func (m *mockArtifactDownloader) downloadArtifact(ctx context.Context, target artifact.Artifact, sourcePath string, upgradeDetails *details.Details, skipVerifyOverride, skipDefaultPgp bool, pgpBytes ...string) (_ string, err error) {
