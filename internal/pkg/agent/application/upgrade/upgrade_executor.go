...
func (u *executeUpgrade) replaceOldWithNew(unpackStepResult unpackStepResult, currentVersionedHome, topPath, agentName, oldRunPath, newRunPath, symlinkPath, newBinPath string, upgradeDetails *details.Details) error {
