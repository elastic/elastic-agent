...
type upgradeCoordinator interface {
	actionCoordinator
	Upgrade(ctx context.Context, version string, sourceURI string, action *fleetapi.ActionUpgrade, performRollback bool, skipVerifyOverride bool, skipDefaultPgp bool, pgpBytes ...string) error
}
