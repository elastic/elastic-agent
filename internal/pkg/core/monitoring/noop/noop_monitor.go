...
// monitoring
func (b *Monitor) EnrichArgs(_ component.Spec, _ string, args []string, _ bool) []string {
	return args
}

// Cleanup cleans up all drops.
func (b *Monitor) Cleanup(component.Spec, string) error {
	return nil
}
