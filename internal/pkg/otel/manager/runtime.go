...
func startSupervisedCollector(ctx context.Context, logger *logger.Logger, collectorPath string, collectorArgs []string, cfg *confmap.Conf, processErrCh chan error, statusCh chan *status.AggregateStatus) (*procHandle, error) {
	if cfg == nil {
