...
import (
	...
	// Extensions
	healthcheckextension "github.com/open-telemetry/opentelemetry-collector-contrib/extension/healthcheckextension" // for putting backpressure when approach a memory limit
