...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/status v0.160.0
...
// Use fork that adds Unix socket transport support.
replace github.com/open-telemetry/opamp-go => github.com/dpaasman00/opamp-go v0.0.0-20260901163641-3ad84468cc95
