...
func (o *opampAgent) NotifyConfigSnapshot(ctx context.Context, snapshot extensioncapabilities.ConfigSnapshot) error {
	if o.capabilities.ReportsEffectiveConfig {
		o.updateEffectiveConfig(snapshot.Effective())
