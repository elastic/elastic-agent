...
require (
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20260225204442-51c23a5080e2
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/azuremonitorreceiver v0.145.0
