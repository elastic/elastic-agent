...
require (
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20260204001850-2898137255fa
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/awslogsencodingextension v0.144.0
...
require (
	...
	go.opentelemetry.io/collector/extension/memorylimiterextension v0.144.0
