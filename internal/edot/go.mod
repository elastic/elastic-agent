...
require (
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20260502190113-1a4685bb3470
...
>>>>>>> 6189a1c76 (Create local copy of `StartMockESDeterministic` for `internal/edot` testing (#13917))
