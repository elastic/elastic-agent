...
require (
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20260319182509-38ef5ab29397
...
require (
	...
	github.com/elastic/opentelemetry-collector-components/internal/elasticattr v0.36.0 // indirect
